    ...
    >
      <input
        className={`
          ...
          checked:border-green-900 checked:bg-green-900 checked:hover:border-green-1100 checked:hover:bg-green-1100
          indeterminate:border-green-900 indeterminate:bg-green-900 indeterminate:hover:border-green-1100 indeterminate:hover:bg-green-1100
