  ...
  render: () => {
    return (
      <table className='w-full text-std-16N-170'>
        ...
        <tbody>
          <tr className='border-b border-solid-gray-500 even:bg-solid-gray-50 hover:bg-green-50'>
            <td className='px-4 py-5 align-top'>データ</td>
            <td className='px-4 py-5 align-top'>データ</td>
            <td className='px-4 py-5 align-top'>データ</td>
            <td className='px-4 py-5 align-top'>データ</td>
  ...
  render: () => {
    ...
    return (
      <table className='w-full text-dns-16N-130'>
        ...
        <tbody>
          <tr className='border-b border-solid-gray-500 [&:has(input:checked)]:bg-green-100'>
