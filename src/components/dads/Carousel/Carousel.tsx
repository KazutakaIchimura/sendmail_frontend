  ...
  return (
    <p className='relative m-0 flex items-center justify-end gap-3 p-0'>
      <button
        ...
        onClick={onPrev}
        className='
          relative flex h-6 w-6 items-center justify-center rounded-full border border-green-1000 bg-white p-0 text-green-1000
                ...
                <div className='[grid-area:main] relative min-w-0'>
                  <a
                    className={`
                      block relative
                      ${slide.href ? `
                        hover:outline hover:outline-4 hover:outline-green-900 hover:-outline-offset-1
          ...
          <a
            className={`
              ...
              ${currentSlide.href ? `
                ...
                hover:outline hover:outline-4 hover:outline-green-900 hover:-outline-offset-2
      ...
      >
        <button
          ...
          className={`
            ...
            hover:outline hover:outline-4 hover:outline-green-900 hover:-outline-offset-1 hover:decoration-[calc(3/16*1rem)]
