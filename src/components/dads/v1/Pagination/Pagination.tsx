...
export const paginationItemStyle = `
  flex h-12 w-12 items-center justify-center rounded-full border border-solid-gray-200 text-oln-16N-100 text-green-1000
  hover:border-green-900 hover:bg-green-50
  focus-visible:outline-2 focus-visible:outline-focus-yellow
  active:border-green-900 active:bg-green-50
`;
...
export const PaginationEllipsis = (props: PaginationEllipsisProps) => {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <circle className='fill-green-900' cx='6' cy='12' r='1' />
      <circle className='fill-green-900' cx='12' cy='12' r='1' />
      <circle className='fill-green-900' cx='18' cy='12' r='1' />
    </svg>
  );
};
