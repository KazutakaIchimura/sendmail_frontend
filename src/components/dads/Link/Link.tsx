...
export const linkDefaultStyle = 'text-green-1000 underline underline-offset-[calc(3/16*1rem)]';
export const linkVisitedStyle = 'visited:text-magenta-900';
export const linkHoverStyle = 'hover:text-green-1000 hover:decoration-[calc(3/16*1rem)]';
