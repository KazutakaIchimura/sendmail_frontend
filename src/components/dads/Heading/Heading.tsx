...
const chipClasses = `
  ...
  before:content-[''] before:absolute before:left-0 before:w-[calc(1em/3)] before:bg-green-900 before:top-[0.2em] before:bottom-[0.1em]
  ...
  return (
    <Component
      ...
      className={`
        ...
        ${rule ? `border-solid border-green-900 ${ruleClasses[rule]}` : ''}
        ${className ?? ''}
      `}
      {...rest}
    >
