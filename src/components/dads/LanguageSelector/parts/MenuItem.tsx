    ...
    <li>
      <a
        ...
        className={`
          ...
          data-[condensed]:min-h-9 data-[current]:bg-green-100 data-[condensed]:py-1.5 data-[condensed]:text-dns-16N-120 data-[current]:font-bold data-[current]:text-green-1000 data-[current]:hover:bg-green-50 data-[current]:hover:text-green-900
          ${className ?? ''}
        `}
