    ...
    const buttonArea = (
      <div className='flex flex-wrap items-center gap-y-2 gap-x-4'>
        <Button
          ...
          className={`
            shrink-0
            group-data-[dragover=true]/drop-area:bg-green-300 group-data-[dragover=true]/drop-area:text-green-1200 group-data-[dragover=true]/drop-area:underline
            group-data-[has-error=true]/file-upload:border-error-1
            data-[dragover=true]:bg-green-300 data-[dragover=true]:text-green-1200 data-[dragover=true]:underline
          `}
            ...
            >
              <div className='flex flex-wrap items-center gap-y-2 gap-x-4'>
                <Button
                  ...
                  variant='outline'
                  size='md'
                  className='shrink-0 group-data-[dragover=true]/drop-area:bg-green-300 group-data-[dragover=true]/drop-area:text-green-1200 group-data-[dragover=true]/drop-area:underline group-data-[has-error=true]/file-upload:border-error-1'
                  onClick={handleSelectButtonClick}
                  ref={selectButtonRef}
                  aria-labelledby={`${labelId} ${buttonId}`}
                  aria-describedby={`${selectedFilesId}-${selectionSummarySuffix} ${errorMessagesId} ${supportTextId}`}
