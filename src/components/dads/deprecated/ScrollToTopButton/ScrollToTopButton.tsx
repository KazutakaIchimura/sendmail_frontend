...
export const scrollToTopButtonStyle = `
  flex h-14 w-14 cursor-pointer items-center justify-center rounded-full border border-green-900 text-green-900 bg-white
  hover:border-green-1000 hover:bg-green-200 hover:text-green-1000
  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-focus-yellow
  active:border-green-1200 active:bg-green-300 active:text-green-1200
`;
